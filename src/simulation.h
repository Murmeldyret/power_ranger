...
void copy_sim_data(igraph_t *, event *, router *, link *, event *, router *, link *);
void run_simulation_loop(igraph_t *, struct routerType *, struct trafficType *, router *, link *, simulationData *);
void establish_connections(igraph_t *, struct routerType *, struct trafficType *, link *, igraph_vector_t *, igraph_vector_t *, int, int, bool *, int);
void send_data(igraph_t *, routerType *, trafficType *, event *, router *, link *, int, double *);
