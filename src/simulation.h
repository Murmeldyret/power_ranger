...
void copy_sim_data(igraph_t *, event *, router *, link_e *, event *, router *, link_e *);
void run_simulation_loop(igraph_t *, struct routerType *, struct trafficType *, router *, link_e *, simulationData *);
...
void send_data(igraph_t *, routerType *, trafficType *, event *, router *, link_e *, int, double *);
